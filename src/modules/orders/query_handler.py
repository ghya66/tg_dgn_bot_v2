...
from src.database import Order, SessionLocal
...
def _format_amount(micro_amount: int | None) -> str:
    """格式化微 USDT 金额"""
...
def get_orders_handler() -> ConversationHandler:
    ...
    return ConversationHandler(
        ...
        states={
            SHOW_ORDERS: [CallbackQueryHandler(handle_callback, pattern=r"^orders_")],
            INPUT_USER_ID: [
