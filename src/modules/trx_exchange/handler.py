...
class TRXExchangeModule(BaseModule):
    ...
    async def start_exchange(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        await message.reply_text(
            TRXExchangeMessages.WELCOME, parse_mode="HTML", reply_markup=TRXExchangeKeyboards.cancel_button()
        )
    ...
    async def input_amount(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        await update.message.reply_text(
            TRXExchangeMessages.INPUT_ADDRESS, parse_mode="HTML", reply_markup=TRXExchangeKeyboards.cancel_button()
        )
    ...
    async def confirm_payment(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        await query.edit_message_text(
            TRXExchangeMessages.WAITING_TX_HASH, reply_markup=TRXExchangeKeyboards.skip_tx_hash()
        )
    ...
    async def handle_tx_hash_input(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        await update.message.reply_text(
            TRXExchangeMessages.ORDER_SUBMITTED.format(order_id=order_id, tx_hash=tx_hash), parse_mode="HTML"
        )
    ...
    async def skip_tx_hash(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        await query.edit_message_text(TRXExchangeMessages.ORDER_SKIP_HASH.format(order_id=order_id), parse_mode="HTML")
