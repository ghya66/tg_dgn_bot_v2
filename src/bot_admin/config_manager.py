    ...
    def set_price(self, key: str, value: float, user_id: int, description: str = "") -> bool:
        ...
        try:
            ...
            if config:
                ...
                config = PriceConfig(config_key=key, config_value=value, description=description, updated_by=user_id)
                session.add(config)
    ...
    def set_content(self, key: str, value: str, user_id: int, description: str = "") -> bool:
        ...
        try:
            ...
            if config:
                ...
                config = ContentConfig(config_key=key, config_value=value, description=description, updated_by=user_id)
                session.add(config)
    ...
    def set_setting(self, key: str, value: str, user_id: int, description: str = "") -> bool:
        ...
        try:
            ...
            if config:
                ...
                config = SettingConfig(config_key=key, config_value=value, description=description, updated_by=user_id)
                session.add(config)
