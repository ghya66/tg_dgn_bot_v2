...
class Order(BaseModel):
    ...
    # Premium 订单专用字段
    premium_months: int | None = Field(None, description="Premium月数 (3/6/12)")
    recipients: list[str] | None = Field(None, description="收件人列表（用户名）")
    delivery_results: dict | None = Field(None, description="交付结果详情")
