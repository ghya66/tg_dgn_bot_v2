...
class TRXService:
    ...
    def set_rate(self, new_rate: Decimal, admin_user_id: int) -> tuple[bool, str | None]:
        """
    ...
    def send_trx(self, order_id: str, recipient_address: str, amount: Decimal) -> tuple[str | None, str | None]:
        """
        发送 TRX
    ...
    def update_order_status(self, order_id: str, status: str, tx_hash: str | None = None) -> bool:
        """
        更新订单状态
